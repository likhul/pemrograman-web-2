        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link <?= (current_url() == base_url('admin')) ? 'active' : '' ?>" href="<?= base_url('admin') ?>">Admin</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link <?= (current_url() == base_url('pengadaan')) ? 'active' : '' ?>" href="<?= base_url('pengadaan') ?>">Pengadaan</a>
                    </li>
                </ul>
            </div>
        </div>
